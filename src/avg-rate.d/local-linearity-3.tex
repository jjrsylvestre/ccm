...
[
	...
	\node[below] at (\xmin,\ymin) {$t_2$};
	\node[below] at (\xmax,\ymin) {$t_3$};
	...
	\draw[blue,thick] (2.94,3.683) rectangle (3.06,3.817);
	\draw[blue,dashed] (2.94,3.683) -- (2.94,\ymin) node[below] {$t_4$};
	\draw[blue,dashed] (3.06,3.683) -- (3.06,\ymin) node[below] {$t_5$};
