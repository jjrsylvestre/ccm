...
[
	...
	\draw[dashed] (\xmax,1) -- (0,1) node[left] {$4 - 3$};
	\draw[dashed] (\xmax,7) -- (0,7) node[left] {$4 + 3$};

	\draw[dashed] (1,7) -- (1,0) node[below] {$1$};
	\draw[dashed] (3,7) -- (3,0) node[below] {$3$};

	% graph
	\draw[blue, domain=-0.5:2, smooth] plot (\x,{\x * \x});
	\draw[very thick, green, domain=1:2, smooth] plot (\x,{\x * \x});

	\draw[dashed] (p) -- (l) -- (2,0) node[below] {$2$};
	\draw[blue] (l) -- (3.85,0.15);

	\draw[very thick, green] (l) -- (3,1);
