...
[
	...
	\fill[green!33!gray] (1,0.75) rectangle (3,0);
	...
	\draw[blue,very thick] (start) -- (stop);

	% high
	\node[green!33!black,closedpt] at (1,0.75) (start) {};
	\node[green!33!black,thick,openpt] at (3,0.75) (stop) {};
	\draw[green!33!black,very thick] (start) -- (stop);

	% off
	\node[blue,closedpt] at (3,0) (start) {};
	\draw[blue,very thick] (start) -- (\xmax,0);
