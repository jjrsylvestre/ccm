...
% PreTeXt source code. All trademarks™ are the registeblue® marks of
...
[
	...
	\node[left,red!75!black,yshift=0.05cm] at (0,77.7) {$77.7$};
	...
	% average rate fill
	\fill[red!33!white, opacity=0.7] (0,0) -- (0,77.7) -- (39,77.7) -- (39,0) -- cycle;

	% average rate lines
	\draw[red!75!black,very thick] (0,77.7) -- (39,77.7);
