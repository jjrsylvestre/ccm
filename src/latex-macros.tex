...
\newcommand{\opdblddt}{\opnthddt[2]}% Leibniz differential operator, squared
\newcommand{\dblddt}[1]{\nthddt[2]{#1}}% Leibniz second derivative, partially filled in
\newcommand{\dbldqdt}{\nthdqdt[2]}% Leibniz second derivative, filled in
\newcommand{\nthderiv}[2][n]{{#2}^{(#1)}}% nth derivative in function notation
\newcommand{\nthmaclaurin}[1][n]{M_{#1}}% degree-n Maclaurin polynomial
\newcommand{\nthtaylor}[2][n]{T_{#1,#2}}% degree-n Taylor polynomial with base point
\newcommand{\nthremainder}[2][n]{R_{#1,#2}}% degree-n Taylor polynomial with base point
...
\newcommand{\lrabsseq}[1]{\lrseq{\abs{#1}}}% abs value sequence in sized brackets
...
\newcommand{\nseqtail}[2][N]{{\nseq{#2}}_{n \ge #1}}% sequence in brackets with restricted domain and standard index variable n
\newcommand{\lrseqtail}[2][n \ge N]{{\lrseq{#2}}_{#1}}% sequence in sized brackets with restricted domain
\newcommand{\bbseqtail}[2][n \ge N]{{\bbseq{#2}}_{#1}}% sequence in larger brackets with restricted domain
\newcommand{\absseqtail}[2][n \ge N]{{\absseq{#2}}_{#1}}% abs value sequence in larger brackets with restricted domain
\newcommand{\lrabsseqtail}[2][n \ge N]{{\lrabsseq{#2}}_{#1}}% abs value sequence in sized brackets with restricted domain
\newcommand{\nabsseqtail}[2][N]{{\nabsseq{#2}}_{n \ge #1}}% abs value sequence in sized brackets with restricted domain and standard index variable n

\newcommand{\leftdomain}[1][D]{{#1}^{-}}% left-hand domain for left-hand limits
\newcommand{\rightdomain}[1][D]{{#1}^{+}}% right-hand domain for right-hand limits
\newcommand{\setdef}[2]{\left\{\mathrel{}#1\mathrel{}\middle|\mathrel{}#2\mathrel{}\right\}}% spaced out set definition
\newcommand{\inlinesetdef}[2]{\{\mathrel{}#1\mathrel{}\mid\mathrel{}#2\mathrel{}\}}% spaced out set definition

\newcommand{\lhopeq}{\overset{\text{l'H}}{=}}% equals sign for l'Hopital's Rule

\newcommand{\convset}[1]{\mathcal{#1}}% curly font for set of convergence for a power series
