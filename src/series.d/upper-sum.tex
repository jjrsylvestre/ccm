...
[
	...
	% rectangle fills
	\fill[blue!30!white] (0,2) rectangle (1,0);
	\fill[blue!30!white] (1,1.779) rectangle (2,0);
	\fill[blue!30!white] (2,1.607) rectangle (3,0);
	\fill[blue!30!white] (3,1.472) rectangle (4,0);
	\fill[blue!30!white] (4,1.368) rectangle (5,0);
	\fill[blue!30!white] (5,1.287) rectangle (6,0);
	...
	\node[blue,openpt] at (1,2) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
	\draw[blue!60!white,dashed] (stop.south) -- (1,0);
	%
	\node[blue,closedpt] at (1,1.779) (start) {};
	\node[blue,openpt] at (2,1.779) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
	\draw[blue!60!white,dashed] (stop.south) -- (2,0);
	%
	\node[blue,closedpt] at (2,1.607) (start) {};
	\node[blue,openpt] at (3,1.607) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
	\draw[blue!60!white,dashed] (stop.south) -- (3,0);
	%
	\node[blue,closedpt] at (3,1.472) (start) {};
	\node[blue,openpt] at (4,1.472) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
	\draw[blue!60!white,dashed] (stop.south) -- (4,0);
	%
	\node[blue,closedpt] at (4,1.368) (start) {};
	\node[blue,openpt] at (5,1.368) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
	\draw[blue!60!white,dashed] (stop.south) -- (5,0);
	%
	\node[blue,closedpt] at (5,1.287) (start) {};
	\node[blue,openpt] at (6,1.287) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
	\draw[blue!60!white,dashed] (stop.south) -- (6,0);
	%
	\node[blue,closedpt] at (8,1.135) (start) {};
	\node[blue,openpt] at (9,1.135) (stop) {};
	\draw[blue,thin] (start.east) -- (stop.west);
